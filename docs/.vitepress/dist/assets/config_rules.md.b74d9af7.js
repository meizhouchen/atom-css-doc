import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.47804b91.js";const g=JSON.parse('{"title":"rules 规则","description":"","frontmatter":{},"headers":[],"relativePath":"config/rules.md","filePath":"config/rules.md"}'),p={name:"config/rules.md"},o=l(`<h1 id="rules-规则" tabindex="-1">rules 规则 <a class="header-anchor" href="#rules-规则" aria-label="Permalink to &quot;rules 规则&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark has-highlighted-lines vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// atomcss.config.js</span></span>
