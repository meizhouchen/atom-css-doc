import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.47804b91.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/config/outPutCss.md","filePath":"guide/config/outPutCss.md"}'),l={name:"guide/config/outPutCss.md"},o=p(`<h2 id="把生成的css输出到指定路径的文件中" tabindex="-1">把生成的css输出到指定路径的文件中 <a class="header-anchor" href="#把生成的css输出到指定路径的文件中" aria-label="Permalink to &quot;把生成的css输出到指定路径的文件中&quot;">​</a></h2><p>便于查看生成的css内容，便于开发者知道有哪些css会被影响</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark has-highlighted-lines vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// atomcss.config.js</span></span>
...
<span class="line"><span style="color:#24292E;">...</span></span></code></pre></div>`,5),e=[o];function t(c,r,i,E,y,d){return n(),a("div",null,e)}const m=s(l,[["render",t]]);export{h as __pageData,m as default};
