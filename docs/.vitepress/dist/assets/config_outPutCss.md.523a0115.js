import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.2127afa9.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"config/outPutCss.md","filePath":"config/outPutCss.md"}'),p={name:"config/outPutCss.md"},o=l(`<h2 id="把生成的css输出到指定路径的文件中" tabindex="-1">把生成的css输出到指定路径的文件中 <a class="header-anchor" href="#把生成的css输出到指定路径的文件中" aria-label="Permalink to &quot;把生成的css输出到指定路径的文件中&quot;">​</a></h2><p>便于查看生成的css内容，便于开发者知道有哪些css会被影响</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark has-highlighted-lines vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// vue.config.js</span></span>
