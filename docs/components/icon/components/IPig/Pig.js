...
export default IconWrapper(
  ...
  props =>
    ...
    '"/>' +
    '<ellipse cx="24" cy="29" rx="8" ry="7" fill="' +
    props.colors[1] +
    '" stroke="' +
    props.colors[0] +
    '" stroke-width="' +
    ...
    props.colors[0] +
    '"/>' +
    '<circle cx="21" cy="29" r="2" fill="' +
    props.colors[2] +
    '"/>' +
    '<circle cx="31" cy="18" r="2" fill="' +
    props.colors[0] +
    '"/>' +
    '<circle cx="27" cy="29" r="2" fill="' +
    props.colors[2] +
    '"/>' +
    '</svg>'
)
