...
<script>
import SurprisedFaceWithOpenBigMouth from './SurprisedFaceWithOpenBigMouth.js'

export default {
  name: 'ISurprisedFaceWithOpenBigMouth',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return SurprisedFaceWithOpenBigMouth(this)
    }
  },
