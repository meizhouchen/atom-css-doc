...
export default IconWrapper(
  ...
  props =>
    ...
    props.strokeWidth +
    '"/>' +
    '<path d="M15.4824 12.4634L32.0005 17.7887" stroke="' +
    props.colors[2] +
    '" stroke-width="' +
    props.strokeWidth +
    '" stroke-linecap="' +
    props.strokeLinecap +
    '"/>' +
    '<path d="M15.4824 17.7886L32.0005 12.4632" stroke="' +
    props.colors[2] +
    '" stroke-width="' +
    props.strokeWidth +
    '" stroke-linecap="' +
