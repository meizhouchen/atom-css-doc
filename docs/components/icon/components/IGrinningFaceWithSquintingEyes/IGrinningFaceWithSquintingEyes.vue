...
<script>
import GrinningFaceWithSquintingEyes from './GrinningFaceWithSquintingEyes.js'

export default {
  name: 'IGrinningFaceWithSquintingEyes',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return GrinningFaceWithSquintingEyes(this)
    }
  },
