...
<script>
import RectangularCircularSeparation from './RectangularCircularSeparation.js'

export default {
  name: 'IRectangularCircularSeparation',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return RectangularCircularSeparation(this)
    }
  },
