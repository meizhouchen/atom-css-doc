...
<script>
import GrinningFaceWithTightlyClosedEyes from './GrinningFaceWithTightlyClosedEyes.js'

export default {
  name: 'IGrinningFaceWithTightlyClosedEyes',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return GrinningFaceWithTightlyClosedEyes(this)
    }
  },
