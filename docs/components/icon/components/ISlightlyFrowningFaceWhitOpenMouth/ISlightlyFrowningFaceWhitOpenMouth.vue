...
<script>
import SlightlyFrowningFaceWhitOpenMouth from './SlightlyFrowningFaceWhitOpenMouth.js'

export default {
  name: 'ISlightlyFrowningFaceWhitOpenMouth',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return SlightlyFrowningFaceWhitOpenMouth(this)
    }
  },
