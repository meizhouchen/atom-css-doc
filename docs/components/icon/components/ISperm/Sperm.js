...
export default IconWrapper(
  ...
  props =>
    ...
    props.strokeWidth +
    '"/>' +
    '<path d="M13.6175 22.3169C10.0769 26.2145 9.60934 29.1762 12.2147 31.2019C14.8201 33.2276 18.0918 32.2293 22.0296 28.2071" stroke="' +
    props.colors[0] +
    '" stroke-width="' +
    props.strokeWidth +
    '" stroke-linecap="' +
    props.strokeLinecap +
    '"/>' +
    '<path d="M12.2386 31.2274C9.14181 34.6146 8.57222 37.7734 10.5299 40.7039C13.4663 45.0997 19.2838 44.8594 22.124 41.5828C24.9642 38.3062 30.3082 30.1868 36.183 31.8559C42.0578 33.525 41.0605 39.9438 37.122 40.6182" stroke="' +
    props.colors[0] +
    '" stroke-width="' +
    props.strokeWidth +
    '" stroke-linecap="' +
