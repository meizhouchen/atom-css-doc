...
export default IconWrapper(
  ...
  props =>
    ...
    '"/>' +
    '<path d="M8 22.4889V44H40V22" stroke="' +
    props.colors[0] +
    '" stroke-width="' +
    props.strokeWidth +
    '" stroke-linecap="' +
    ...
    props.strokeLinejoin +
    '"/>' +
    '<path d="M8 11.8222V4H40V12" stroke="' +
    props.colors[0] +
    '" stroke-width="' +
    props.strokeWidth +
    '" stroke-linecap="' +
    ...
    props.strokeLinejoin +
    '"/>' +
    '<rect x="19" y="32" width="10" height="12" fill="' +
    props.colors[1] +
    '" stroke="' +
    props.colors[0] +
    '" stroke-width="' +
