...
<script>
import RectangularCircularConnection from './RectangularCircularConnection.js'

export default {
  name: 'IRectangularCircularConnection',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return RectangularCircularConnection(this)
    }
  },
