...
<script>
import GrinningFaceWithTightlyClosedEyesOpenMouth from './GrinningFaceWithTightlyClosedEyesOpenMouth.js'

export default {
  name: 'IGrinningFaceWithTightlyClosedEyesOpenMouth',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return GrinningFaceWithTightlyClosedEyesOpenMouth(this)
    }
  },
