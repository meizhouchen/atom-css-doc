...
<script>
import LoudlyCryingFaceWhitOpenMouth from './LoudlyCryingFaceWhitOpenMouth.js'

export default {
  name: 'ILoudlyCryingFaceWhitOpenMouth',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return LoudlyCryingFaceWhitOpenMouth(this)
    }
  },
