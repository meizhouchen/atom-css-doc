...
<script>
import HorizontalSpacingBetweenItems from './HorizontalSpacingBetweenItems.js'

export default {
  name: 'IHorizontalSpacingBetweenItems',
  components: {},
  props: {
    size: {
      type: [String, Number],
  ...
  computed: {
    ...
    url11() {
      return HorizontalSpacingBetweenItems(this)
    }
  },
